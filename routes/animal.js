...
const { addAnimalToUser, getAnimalInfo, removeAnimalFromUser, updateAnimal, getAllAnimalsInfo,BookVaccinationForAnimal,addVaccine, getVaccines } = require('../controllers/animal');
const router = express.Router()
const { errorHandler } = require("../helpers/errorHandler");
const { authJwt } = require("../helpers/jwt");

router.get('/all/:id',getAllAnimalsInfo)
router.post('/getVaccines',getVaccines)
